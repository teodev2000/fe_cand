...
const Header = ({ onSearch }) => {
  ...
  return (
    <>
      <header className="bg-gradient-to-br md:from-sky-900 md:to-sky-700 from-blue-800 to-blue-700 text-white flex justify-between items-center shadow-lg relative z-50 md:flex-row flex-col md:gap-0 gap-4">
        <img src={images[currentIndex]} alt="banner" className="w-full h-[200px] object-cover relative" />

        <div className="absolute px-8 py-4 w-full">
          ...
          <div className="flex items-center w-full md:w-auto">
            ...
            <div className="flex items-center gap-10">
              <img
                src="/logoca-removebg-preview.png"
                alt="Công An Việt Nam"
                className="w-[150px] h-[150px] object-contain rounded-full p-[5px]"
              />
              <div className="flex flex-col">
                <h1 className="m-0 text-xl font-bold drop-shadow-md md:text-[24px] leading-tight">
                  BAN THANH NIÊN
                </h1>
                <p className="m-0 text-sm opacity-90 font-medium md:text-[30px]">
      ...
      <div className="h-[45px] bg-sky-900 w-full flex items-center justify-end">
        {/* Center section with search */}
        <div className="flex-1 max-w-[350px] mx-8 md:mx-8 mx-0 md:max-w-[350px] w-full">
          <form onSubmit={handleSearch} className="w-full">
            <div className="relative flex items-center">
              <input
                type="text"
                ...
                value={searchInput}
                onChange={(e) => setSearchInput(e.target.value)}
                className="w-full px-5 py-1 pr-[50px] border-none rounded-full text-base outline-none bg-white/95 text-gray-800 shadow-md transition-all duration-300 ease-in-out focus:bg-white focus:shadow-lg focus:-translate-y-[1px]"
              />
              <button
                type="submit"
                className="absolute right-2 bg-sky-700 border-none rounded-full w-7 h-7 flex items-center justify-center text-white cursor-pointer transition-all duration-300 ease-in-out hover:bg-[#991b1b] hover:scale-110"
              >
